...
for name in itemTable.index:
    items.append(name)
    # print(name)
#     buyingTop3 = pd.Series(items[:3])
# print(buyingTop3)
buyinghistory =  items[:3]

print(buyinghistory[0])

# print(BuyingTop3.product)
# str1 = ''.join(str(e) for e in buyinghistory)

similarItem = ''.join(buyinghistory[0])
result = get_recommendations(similarItem)

# ######################  ISSUE !!!! ######################
# for i, itemName in buyingTop3.iteritems():
#     print(itemName)
#     result = get_recommendations(str(itemName))
#     print("--------------------------------------")
#     print(result)
# ######################  ISSUE !!!! ######################
